...
func SetLogger(l log.Logger) {
	// lcfg := viper.GetStringMap("log-config.gebberish.mi.default")
	ldcfg := viper.GetStringMap("log-config.commands.gebberish.default")
	...
	lcfg := viper.GetStringMap("log-config.commands.gebberish")
